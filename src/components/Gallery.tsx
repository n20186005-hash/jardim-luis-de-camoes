...
const photoIndices = Array.from({ length: 16 }, (_, i) => i + 1);
            ...
            <div className="flex flex-col items-center mt-8 gap-4">
              {!showAll && photos.length > 8 && (
                <button
                  ...
                  className="px-6 py-2.5 rounded-full text-sm font-medium transition-colors text-white"
              ...
              <a
                href="https://maps.app.goo.gl/6WaNcoHmFRCSmj4s5"
                target="_blank"
